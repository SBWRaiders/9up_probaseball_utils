    ...
    <div class="max-w-[1600px] mx-auto">
      ...
      <header class="mb-6 flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-sm text-neutral-500 dark:text-neutral-400 mt-1">돌파, 스킬, 각인, 시너지까지 모든 스탯을 웹에서 간편하게 처리하세요!</p>
        </div>
      </header>
